...
console.log(`${BASE_URL}/filter-services?city=Mumbai&profileType=Service%20Profile&serviceType=premium`);
console.log('');
...
console.log(`${BASE_URL}/filter-services?city=Mumbai&page=2&limit=15&sortBy=yourName&sortOrder=asc`);
console.log('');

console.log('7. Complex multi-filter:');
console.log(`${BASE_URL}/filter-services?profileType=Business%20Profile&city=Bangalore&serviceType=featured&gender=Male&experience=5%2B%20years&page=1&limit=20`);
