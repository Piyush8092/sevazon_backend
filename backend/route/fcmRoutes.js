...
router.delete("/token", authGuard, fcmTokenController.removeToken);

// Get user's active FCM tokens
router.get("/tokens", authGuard, fcmTokenController.getUserTokens);

// Validate FCM token
router.post("/token/validate", authGuard, fcmTokenController.validateToken);
...
router.get("/preferences", authGuard, notificationPreferencesController.getPreferences);
...
router.post("/preferences/reset", authGuard, notificationPreferencesController.resetPreferences);
...
router.post(
  "/history/:notificationId/clicked",
  authGuard,
  notificationHistoryController.markNotificationAsClicked
);

// Get user's notification statistics
router.get("/history/stats", authGuard, notificationHistoryController.getUserNotificationStats);

// Get unread notification count
router.get("/history/unread-count", authGuard, notificationHistoryController.getUnreadCount);

// Mark all notifications as read
router.post("/history/mark-all-read", authGuard, notificationHistoryController.markAllAsRead);
...
router.get("/schedule", authGuard, notificationSchedulerController.getScheduledNotifications);
...
router.get("/schedule/stats", authGuard, notificationSchedulerController.getSchedulingStats);
