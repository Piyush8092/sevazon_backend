...
const {
  ...
  queryAdds,
  AddCreaterView,
  getAllNotVerifiedAdds,
  FilterAdds,
  specificAddAdminView,
  getTotalAdCount,
  getAllAdUser,
  sendNotificationToAddPoster,
  getUserAdsPlans,
...
} = require("../controllers/AllServicesRegistration/UpdateSpecificServices");
const { GetAllServiceListName } = require("../controllers/CreateAllServices/GetAllServiceListName");
const {
  GetAllServiceListSubName,
} = require("../controllers/CreateAllServices/GetAllServiceListSubName");
...
const {
  GetSpecificServices,
} = require("../controllers/AllServicesRegistration/GetSpecificServices");
const { FilterServices } = require("../controllers/AllServicesRegistration/FilterServices");
const {
  DeleteSpecsificServices,
} = require("../controllers/AllServicesRegistration/DeleteSpecificServices");
...
const {
  AdminSpecificServiceView,
} = require("../controllers/AllServicesRegistration/AdminSpecificServiceView");
...
const {
  updateServiceListDetail,
} = require("../controllers/CreateAllServices/updateServiceListDetail");
...
const {
  ...
  showCreateOfferView,
  FilterOffer,
  specificOfferAdminView,
  getTotalOfferCount,
  getAllOfferUser,
  sendNotificationToOfferPoster,
} = require("../controllers/offersAndDiscount");
...
const {
  jobCreaterView,
  getApplyedJobCreterView,
} = require("../controllers/ApplyJob/jobCreaterView");
...
const {
  getSpecificLocalServiceRoute,
} = require("../controllers/localServices/getSpecificLocalService");
...
const {
  createAccountDeletePolicy,
} = require("../controllers/AccountDeletePolicy/AccountDeletePolicyCreate");
const {
  getAccountDeletePolicy,
} = require("../controllers/AccountDeletePolicy/AccountDeletePolicyGet");
const {
  editAccountDeletePolicy,
} = require("../controllers/AccountDeletePolicy/AccountDeletePolicyEdit");
const {
  deleteAccountDeletePolicy,
} = require("../controllers/AccountDeletePolicy/AccountDeletePolicyDelete");
...
const {
  getSpecificAccountDeletePolicy,
} = require("../controllers/AccountDeletePolicy/getSpecificAccountDeletion");
...
const {
  getServiceCreaterView,
} = require("../controllers/AllServicesRegistration/getServiceCreaterView");
...
const {
  getApplicantAcceptedApplications,
} = require("../controllers/ApplyJob/getApplicantAcceptedApplications");
const {
  getApplicantRejectedApplications,
} = require("../controllers/ApplyJob/getApplicantRejectedApplications");
const {
  updateApplyStatusByCreater,
} = require("../controllers/ApplyJob/EditAcceptApplyJobByCreater");
const { getpendingApplications } = require("../controllers/ApplyJob/getpendingApplications");
const {
  getApplicantPendingApplications,
} = require("../controllers/ApplyJob/getApplicantPendingApplications");
const { getRatting } = require("../controllers/AllServicesRegistration/getRatting");
const {
  updateImportantLink,
} = require("../controllers/AllServicesRegistration/updateImportantLink");
...
const {
  getSpecificApplyMatrimony,
} = require("../controllers/applyMatrimony/getSpecificApplyMatrimony");
const { applyMatrimony } = require("../controllers/applyMatrimony/applyMatrimony");
const {
  getAllApplyApplication,
} = require("../controllers/applyMatrimony/getAllApplyedApplication");
...
} = require("../controllers/pricingPlan/getPricingPlansByCategory");
...
} = require("../controllers/payment/syncServiceProfileTypes");
...
const {
  UpdateReportAndBlock,
} = require("../controllers/AllServicesRegistration/UpdateReportAndBlock");
const {
  UpdateServiceProfileBookMark,
} = require("../controllers/AllServicesRegistration/UpdateServiceProfileBookMark");
...
const {
  getReportAndBlockServiceProfile,
} = require("../controllers/user/getReportAndBlockServiceProfile");
const {
  UpdateReportAndBlockMatrimony,
} = require("../controllers/MatrimonyPost/UpdateReportAndBlockMatrimony");
const {
  getReportAndBlockMatrimonyProfile,
} = require("../controllers/MatrimonyPost/getReportAndBlockMatrimonyProfile");
const {
  getBookmarkMatrimonyProfile,
} = require("../controllers/MatrimonyPost/getBookmarkMatrimonyProfile");
const {
  UpdateMatrimonyProfileBookMark,
} = require("../controllers/MatrimonyPost/UpdateMatrimonyProfileBookMark");
...
const {
  getReportAndBlockJobProfile,
} = require("../controllers/JobPost/getReportAndBlockJobProfile");
const {
  UpdateReportAndBlockOffer,
} = require("../controllers/offersAndDiscount/UpdateReportAndBlockOffer");
const { UpdateOfferBookmark } = require("../controllers/offersAndDiscount/UpdateOfferBookmark");
const {
  getReportAndBlockOffer,
} = require("../controllers/offersAndDiscount/getReportAndBlockOffer");
const { getBookmarkOffer } = require("../controllers/offersAndDiscount/getBookmarkOffer");
const {
  UpdateReportAndBlockProperty,
} = require("../controllers/Property/UpdateReportAndBlockProperty");
...
const {
  getBlockMatrimonyUserView,
} = require("../controllers/MatrimonyPost/getBlockMatrimonyUserView");
...
const {
  specificLoaclServicesAdminView,
} = require("../controllers/localServices/specificUserAdminView");
const {
  specificMatrimonyAdminView,
} = require("../controllers/MatrimonyPost/getSpecificUserAdminView");
...
const {
  getTotalLocalServicesCount,
} = require("../controllers/localServices/getTotalLocalServicesCount");
...
const {
  sendNotificationToJobPoster,
} = require("../controllers/JobPost/sendNotificationToJobPoster");
const {
  sendNotificationToMatrimonyPoster,
} = require("../controllers/MatrimonyPost/sendNotificationToMatrimonyPoster");
const {
  sendNotificationToPropertyPoster,
} = require("../controllers/Property/sendNotificationToPropertyPoster");
const {
  sendNotificationToNewsPoster,
} = require("../controllers/NewsPost/sendNotificationToNewsPoster");
const {
  sendNotificationToLocalServicesPoster,
} = require("../controllers/localServices/sendNotificationToLocalServicesPoster");
const {
  sendNotificationToServicePoster,
} = require("../controllers/AllServicesRegistration/sendNotificationToServicePoster");
const {
  getspecificJobApplyAdminView,
} = require("../controllers/ApplyJob/getspecificJobApplyAdminView");
const {
  createZeroAmountSubscription,
} = require("../controllers/payment/createZeroAmountSubscription");
const {
  verifyZeroAmountSubscription,
} = require("../controllers/payment/verifyZeroAmountSubscription");
...
router.get(
  "/get-specific-local-services-admin-view/:id",
  authGuard,
  specificLoaclServicesAdminView
);
//seND notification to local services post user
router.get(
  "/send-notification-to-local-services-poster",
  authGuard,
  sendNotificationToLocalServicesPoster
);
...
router.post(
  "/agora/reset-certificate",
  [authGuard, generalAgoraLimit],
  agoraController.resetToPrimaryCertificate
);

router.post(
  "/agora/switch-certificate",
  [authGuard, generalAgoraLimit],
