...
console.log(
  `AGORA_APP_CERTIFICATE: ${process.env.AGORA_APP_CERTIFICATE ? "configured" : "not set"}`
);
console.log(
  `AGORA_APP_CERTIFICATE_BACKUP: ${process.env.AGORA_APP_CERTIFICATE_BACKUP ? "configured" : "not set"}`
);
