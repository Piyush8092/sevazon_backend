...
const sortByDistrictAndType = (jobs, userDistrict) => {
  return jobs.sort((a, b) => {
    ...
    if (aIsSameDistrict && aIsPremiumOrFeatured && (!bIsSameDistrict || !bIsPremiumOrFeatured))
      return -1;
    if (bIsSameDistrict && bIsPremiumOrFeatured && (!aIsSameDistrict || !aIsPremiumOrFeatured))
      return 1;
