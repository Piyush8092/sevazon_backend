...
const specificNewsAdminView = async (req, res) => {
    try {  
        ...
        res.json({message: 'News detail retrieved successfully', status: 200, data: result, success: true, error: false});
    }
    catch (e) {
...
module.exports = { specificNewsAdminView };
