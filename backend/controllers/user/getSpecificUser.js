...
const getSpecificUser = async (req, res) => {
  try {
    ...
    const result = await userModel
      ...
      .populate("userId", "name email phone profileImage businessName profileType serviceType _id");
