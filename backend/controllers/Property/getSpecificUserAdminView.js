...
const specificPropertyAdminView = async (req, res) => {
    try {  
        ...
        res.json({message: 'Property detail retrieved successfully', status: 200, data: result, success: true, error: false});
    }
    catch (e) {
...
module.exports = { specificPropertyAdminView };
