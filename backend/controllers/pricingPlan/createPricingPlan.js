...
const createPricingPlan = async (req, res) => {
  try {
    ...
    if (
      !payload.title ||
      !payload.category ||
      payload.price1 === undefined ||
      payload.price2 === undefined ||
      payload.originalPrice === undefined ||
      payload.duration1 === undefined ||
      payload.duration2 === undefined ||
      payload.perMonth === undefined ||
      ...
      return res.status(400).json({
        message:
          "All required fields must be provided (title, category, price1, price2, originalPrice, duration1, duration2, perMonth, GSTPercentage, features)",
      });
    }
