  ...
  try {
    ...
    recentActivities.forEach((activity) => {
      ...
      if (activity.subcategory) {
        subcategoryScores[activity.subcategory] =
          (subcategoryScores[activity.subcategory] || 0) + weight;
      }

      // Score content types
      contentTypeScores[activity.contentType] =
        (contentTypeScores[activity.contentType] || 0) + weight;
    });
