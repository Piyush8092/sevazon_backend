...
const getApplicantRejectedApplications = async (req, res) => {
    try {  
        ...
        res.json({
            message: 'Your rejected applications retrieved successfully', 
            status: 200, 
            data: result, 
            success: true, 
            error: false, 
...
module.exports = { getApplicantRejectedApplications };
